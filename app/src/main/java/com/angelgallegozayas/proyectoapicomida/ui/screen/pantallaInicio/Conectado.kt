...
@Composable
fun ConectadoScreen(auth: AuthManager, navigateToLogin: () -> Unit) {
        ...
        Box(modifier = Modifier
            ...
            Column(
                ...
                TextField(
                    ...
                    leadingIcon = {
                        Icon(Icons.Default.Person, contentDescription = "ic_usuario")
                    },
                    singleLine = true
                )
                ...
                TextField(
                    ...
                    modifier = Modifier.width(335.dp),
                    leadingIcon = {
                        Icon(Icons.Default.Mail, contentDescription = "ic_email")
                    },
                    singleLine = true
                )
                ...
                TextField(
                    ...
                    modifier = Modifier.width(335.dp),
                    leadingIcon = {
                        Icon(Icons.Default.Lock, contentDescription = "ic_password")
                    },
                    singleLine = true
                )
